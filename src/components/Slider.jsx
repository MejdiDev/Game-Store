    ...
    return (
        <section id="slider_section">
            <div id="swiper_wrapper">
                ...
                >
                    {
                        games.map((game, index) =>
                            <SwiperSlide key={`main-game-slider-child-${index}`}>
                                <Link to={`/product/${game.name.replace(/\s+/g, '-').replace(/\//g, '-')}-${game.kinguinId}`}>
                                    <div style={{ backgroundImage: `url('${game?.coverImageOriginal ? game.coverImageOriginal : game.images?.cover?.url}')` }} className="slider_child">
                ...
                <div className="nav_wrapper main">
                ...
                <span id="platforms">
                    {
                        ...
                        <p key={`game-main-platform`}>{selGame?.platform}</p>
